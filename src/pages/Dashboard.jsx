        ...
        <div className="px-10 py- flex flex-col lg:flex-row gap-6 -mt-[14vh] -ml-3">
          <div className="flex flex-col gap-3 w-full lg:w-[65%] ">
            <div className="bg-[#FFFFFF] rounded-md p-4 shadow h-[auto] flex  items-start hover:scale-105 transition ">
              ...
              <div className="flex flex-col  items-end gap-6">
                ...
                />
                <div className="">
                  <div className="text-[12px] flex gap-2 tracking-[0px]">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              >
                ...
                <div className="flex text-[12px] gap-2 text-gray-600 mt-2">
              ...
              <div className="bg-white rounded-lg px-2  shadow-md flex-1 hover:scale-105 transition">
                <h2 className="font-semibold text-xl mb-4 text-[#084C40]">
                  Recent Searches
                </h2>
                <ul className="space-y- text-gray-700 text-[12px]">
                ...
                <div className=" w-full flex justify-end p-1">
                  <button className="text-[12px] text-[#fff] bg-[#B39847] p-1 rounded-md  "> Click to see More</button>
                </div>
              </div>
            </div>
            ...
            <div className=" rounded-md space-y-1  ">
              ...
              <h3 className="font-semibold text-[16px]">How to Use It</h3>
              <p className="text-gray-700 text-[12px]">
                For new users, there are two key resources to help you navigate
                the Codification:
              </p>
              <ol className="list-decimal pl-5  text-gray-700 text-[12px] space-y-1">
                <li>
          ...
          <div className="flex flex-col gap-3 w-full lg:w-[30%]">
            ...
            <div className="bg-[#FFFFFF] rounded-md px-3 shadow hover:scale-105 transition">
              <h2 className="font-semibold text-[14px] ">History</h2>
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left  text-[14px]">Standards</th>
                    <th className="text-left  text-[14px]">Articles</th>
                    <th className="text-left  text-[14px]">Date</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
                    <td className="py-[0.5vh] text-[12px]">01/03 / June</td>
                    <td className="py-[0.5vh] text-[12px]">Annual</td>
                    <td className="py-[0.5vh] text-[12px]">May 1, 2023</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-[0.5vh] text-[12px]">04/05 / June</td>
                    <td className="py-[0.5vh] text-[12px]">Annual</td>
                    <td className="py-[0.5vh] text-[12px]">May 1, 2025</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-[0.5vh] text-[12px]">06/05 / June</td>
                    <td className="py-[0.5vh] text-[12px]">Annual</td>
                    <td className="py-[0.5vh] text-[12px]">May 1, 2025</td>
                  </tr>
                  <tr>
                    <td className="py-[0.5vh] text-[12px]">07/05 / June</td>
                    <td className="py-[0.5vh] text-[12px]">Annual</td>
                    <td className="py-[0.5vh] text-[12px]">May 1, 2025</td>
                  </tr>
                </tbody>
            ...
            <div className="bg-[#FFF4D6] rounded-md px-3 py-2 space-y-2 shadow hover:scale-105 transition">
              <h2 className="font-semibold text-[14px] ">Recently Viewed</h2>
              <p className="text-gray-700 mb-3 text-[12px]">
